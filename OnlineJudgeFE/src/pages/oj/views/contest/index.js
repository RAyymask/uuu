...
const HomeworkList = () => import(/* webpackChunkName: "contest" */ './HomeworkList.vue')

export {ContestDetails, ContestList, ContestProblemList, ContestRank, ACMContestHelper, HomeworkList}
