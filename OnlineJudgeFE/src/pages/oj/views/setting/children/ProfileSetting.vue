    ...
    <Form ref="formProfile" :model="formProfile">
      <Row type="flex" :gutter="30" justify="space-around">
        <Col :span="11">
          ...
          <Form-item label="POJ_id">
            <Input v-model="POJ_id"/>
          </Form-item>
        ...
        <Col :span="11">
          <Form-item label="studentNumber">
            <Input v-model="formProfile.studentNumber"/>
          </Form-item>
          ...
          <Form-item label="CodeForces_id">
            <Input v-model="CodeForces_id"/>
          </Form-item>
        </Col>
      </Row>
    </Form>
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      if (this.formProfile.oj_username !== '') {
        var len = this.formProfile.oj_username.length
        let tempoj = this.formProfile.oj.toString().split('|')
        let tempusername = this.formProfile.oj_username.toString().split('|')
        for (var i = 0; i < len; i++) {
    ...
    methods: {
      ...
      updateProfile () {
        ...
        this.formProfile.oj = ''
        this.formProfile.oj_username = ''
        if (this.POJ_id !== '') {
          this.formProfile.oj = 'POJ'
          this.formProfile.oj_username = this.POJ_id
        }
        if (this.CodeForces_id !== '') {
          if (this.formProfile.oj !== '') {
            this.formProfile.oj += '|'
            this.formProfile.oj_username += '|'
          }
          this.formProfile.oj += 'CodeForces'
          this.formProfile.oj_username += this.CodeForces_id
        }
