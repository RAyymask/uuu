  ...
  <div class="view">
    <Panel title="Homework List">
      ...
      <el-table
        ...
        <el-table-column
          ...
          <div slot-scope="scope">
            ...
            <!-- <icon-btn icon="download" name="Score"
      ...
      <div class="panel-options">
        <el-button type="primary"
                   ...
                   @click="addProblemDialogVisible = true">Add From ContestList
        </el-button>
        <el-pagination
          class="page"
    ...
    <el-dialog title="Download Contest Submissions"
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-dialog title="Add Homework to Class"
               width="80%"
               :visible.sync="addProblemDialogVisible"
               @close-on-click-modal="false">
      <add-homework-component :classID="classId" @on-change="getContestList(this.currentPage)"></add-homework-component>
    </el-dialog>
  </div>
</template>
...
<script>
  ...
  export default {
    name: 'HomeworkList',
    components: {
      'add-homework-component': AddHomework
    },
    data () {
      return {
        pageSize: 10,
