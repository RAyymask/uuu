<template>
  <el-menu class="vertical_menu"
    ...
    <el-submenu index="classes">
      <template slot="title"><i class="el-icon-school"></i>{{$t('m.ClAss')}}</template>
      <el-menu-item index="/class">{{$t('m.Class_List')}}</el-menu-item>
      <el-menu-item index="/class/create">{{$t('m.Create_Class')}}</el-menu-item>
    </el-submenu>
  </el-menu>
</template>
