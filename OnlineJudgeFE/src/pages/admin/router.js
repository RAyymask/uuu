...
// 引入 view 组件
import { Announcement, Conf, Contest, ContestList, Home, JudgeServer, Login, Class, ClassList, HomeworkList, ClassScore,
  Problem, ProblemList, User, PruneTestCase, Dashboard, ProblemImportOrExport, ClassMemberList } from './views'
Vue.use(VueRouter)
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          name: 'class-homeworklist',
          component: HomeworkList
        },
        {
          path: '/homework/:classId/create',
          name: 'create-homework',
          component: Contest
        },
        {
          path: '/class/:classId/Score',
          name: 'class-score-list',
